...
// source: testhellochain/venue.proto
...
func (*Venue) Descriptor() ([]byte, []int) {
	return fileDescriptor_b22253cfb8a4dee4, []int{0}
}
...
func (m *Venue) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func init() {
	proto.RegisterType((*Venue)(nil), "testhellochain.testhellochain.Venue")
}

func init() { proto.RegisterFile("testhellochain/venue.proto", fileDescriptor_b22253cfb8a4dee4) }

var fileDescriptor_b22253cfb8a4dee4 = []byte{
	// 179 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Venue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Category) > 0 {
		...
		i = encodeVarintVenue(dAtA, i, uint64(len(m.Category)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintVenue(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0xa
	}
...
func skipVenue(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupVenue
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupVenue = fmt.Errorf("proto: unexpected end of group")
)
